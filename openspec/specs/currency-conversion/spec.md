...
TBD - Fornecer ao usuário uma forma simples de converter valores entre moedas diferentes, selecionando moeda de origem e destino, visualizando o valor convertido automaticamente.
